...
public interface TsfHeadRepo extends JpaRepository<TsfHead, String> {
	...
	List<TsfHead> findAllByOrderByCreationDateDesc();

	List<TsfHead> findAllByOrderByCreationDateAsc();

	List<TsfHead> findByTsfIdContaining(String id);

	List<TsfHead> findByReasonCodeOrStatus(String param, String param2);
